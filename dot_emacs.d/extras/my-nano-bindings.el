;; the default nano-bindings.el from nrougier overrides M-ret and
;; messes up org-mode norms. So I won't use it any more. Instead, I've
;; copypasta'd the bits I want here.
...
;; VVVVVVVV The bit that I don't want VVVVVVVVVVVV
